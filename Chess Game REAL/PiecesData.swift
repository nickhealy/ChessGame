...
enum PieceKeys: String, CaseIterable, Codable {
    case w_rook_1 = "w_rook_1",
         w_rook_2 = "w_rook_2",
         w_knight_1 = "w_knight_1",
         w_knight_2 = "w_knight_2",
         w_bishop_1 = "w_bishop_1",
         w_bishop_2 = "w_bishop_2",
         w_queen = "w_queen",
         w_king = "w_king",
         w_pawn_1 = "w_pawn_1",
         w_pawn_2 = "w_pawn_2",
         ...
         b_rook_1 = "b_rook_1",
         b_rook_2 = "b_rook_2",
         b_knight_1 = "b_knight_1",
         b_knight_2 = "b_knight_2",
         b_bishop_1 = "b_bishop_1",
         b_bishop_2 = "b_bishop_2",
         b_queen = "b_queen",
         b_king = "b_king",
         b_pawn_1 = "b_pawn_1",
         b_pawn_2 = "b_pawn_2",
